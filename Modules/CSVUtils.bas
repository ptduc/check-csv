...
'
Public Function ParseCSVToCollection(ByRef csvText As String, ByVal separater As String, Optional ByVal fileOverView As String, Optional ByVal line As Long) As Collection
...
Head:
    ...
    Do While GetOneRecord(csvText, csvPos, recordText, fileOverView, line)
        ...
        recordPos = 1
        recordTextComma = recordText & separater
        Do While FindNextSeparator(recordTextComma, recordPos, fieldText, separater, , fileOverView, line)
...
'
Public Function ParseCSVToArray(ByRef csvText As String, ByVal separater As String, Optional ByVal fileOverView As String, Optional ByVal line As Long) As Variant
    ' "On Error Resume Next" only if CSVUtilsAnyErrorIsFatal is True
    Err.Clear
    If CSVUtilsAnyErrorIsFatal Then GoTo Head
    On Error Resume Next
...
'     updating csvPos
'
Private Function GetOneRecord(ByRef csvText As String, ByRef csvPos As Long, ByRef recordText As String, Optional ByVal fileOverView As String, Optional ByVal line As Long) As Boolean
  GetOneRecord = FindNextSeparator(csvText, csvPos, recordText, "" & vbCr, "" & vbLf, fileOverView, line)
